...
export default class TaxModuleService extends TaxModuleService_base implements ITaxModuleService {
    ...
    protected taxProviderService_: ModulesSdkTypes.IMedusaInternalService<InferEntityType<typeof TaxProvider>>;
    ...
    updateTaxRegions(data: TaxTypes.UpdateTaxRegionDTO, sharedContext?: Context): Promise<TaxTypes.TaxRegionDTO>;
