...
function bundle() {
    return __awaiter(this, void 0, void 0, function () {
        var adminDir, pathExists, pkg, identifier, _a, routes, widgets, settings, widgetImports, routeImports, settingImports, body, virtualEntry, dependencies, peerDependencies, external, dist, distExists, error_1, bundle_1, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    pathExists = _b.sent();
                    if (!pathExists) {
                        admin_ui_1.logger.panic("The `src/admin` directory could not be found. It appears that your project does not include any admin extensions.");
                    }
                ...
                case 3:
                    ...
                    widgetImports = (0, ts_dedent_1["default"])(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    ", "\n  "], ["\n    ", "\n  "])), widgets
                        .map(function (widget, i) {
                        return "import Widget".concat(i, ", { config as widgetConfig").concat(i, " } from \"").concat((0, admin_ui_1.normalizePath)(widget), "\"");
                    })
                        .join("\n"));
                    routeImports = (0, ts_dedent_1["default"])(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    ", "\n    "], ["\n    ", "\n    "])), routes
                        .map(function (route, i) {
                        return "import Route".concat(i).concat(route.hasConfig ? ", { config as routeConfig".concat(i, " }") : "", " from \"").concat((0, admin_ui_1.normalizePath)(route.file), "\"");
                    })
                        .join("\n"));
                    settingImports = (0, ts_dedent_1["default"])(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    ", "\n    "], ["\n    ", "\n    "])), settings
                        .map(function (setting, i) {
                        return "import Setting".concat(i, ", { config as settingConfig").concat(i, " } from \"").concat((0, admin_ui_1.normalizePath)(setting.file), "\"");
                    })
                        .join("\n"));
                    body = (0, ts_dedent_1["default"])(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    const entry = {\n      identifier: \"", "\",\n      extensions: [\n        ", "\n        ", "\n        ", "\n        ", "\n        ", "\n      ],\n    }\n  "], ["\n    const entry = {\n      identifier: \"", "\",\n      extensions: [\n        ", "\n        ", "\n        ", "\n        ", "\n        ", "\n      ],\n    }\n  "])), identifier, routes.length > 0
                        ? routes
                            .map(function (r, i) { return "{\n                Component: Route".concat(i, ",\n                config: { path: \"").concat(r.path, "\", type: \"route\"").concat(r.hasConfig ? ", ...routeConfig".concat(i) : "", " }\n            }"); })
                            .join(",\n")
                        : "", routes.length > 0 && settings.length > 0 ? "," : "", settings.length > 0
                        ? settings
                            .map(function (r, i) { return "{\n                Component: Route".concat(i, ",\n                config: { path: \"").concat(r.path, "\", type: \"setting\", ...settingConfig").concat(i, " }\n            }"); })
                            .join(",\n")
                        : "", settings.length > 0 && widgets.length > 0 ? "," : "", widgets
                        .map(function (_, i) { return "{\n            Component: Widget".concat(i, ",\n            config: { type: \"widget\", ...widgetConfig").concat(i, " }\n        }"); })
                        .join(",\n"));
                    virtualEntry = (0, ts_dedent_1["default"])(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    ", "\n    ", "\n    ", "\n\n    ", "\n\n    export default entry\n  "], ["\n    ", "\n    ", "\n    ", "\n\n    ", "\n\n    export default entry\n  "])), widgetImports, routeImports, settingImports, body);
