...
class PaymentModuleService extends utils_1.ModulesSdkUtils.MedusaService(generateMethodForModels) {
    ...
    async createAccountHolder(input, sharedContext) {
        ...
        try {
            providerAccountHolder =
                await this.paymentProviderService_.createAccountHolder(input.provider_id, { context: input.context });
            ...
            if (providerAccountHolder) {
                await this.paymentProviderService_.deleteAccountHolder(input.provider_id, {
                    context: {
                        account_holder: providerAccountHolder,
                    },
                });
            }
            if (accountHolder) {
    ...
    // @ts-expect-error
    async createRefundReasons(data, sharedContext) {
        return super.createRefundReasons(data, sharedContext);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [Array, Object]),
    __metadata("design:returntype", Promise)
], PaymentModuleService.prototype, "createRefundReasons", null);
__decorate([
    (0, utils_1.InjectManager)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
