...
var _Orchestrator_instances, _Orchestrator_lockingModule, _Orchestrator_lockingOwner, _Orchestrator_state, _Orchestrator_options, _Orchestrator_currentIndex, _Orchestrator_entities, _Orchestrator_acquireLock, _Orchestrator_processAtIndex;
...
class Orchestrator {
    ...
    constructor(container, entities, options) {
        ...
        __classPrivateFieldSet(this, _Orchestrator_lockingModule, container.resolve("locking"), "f");
    ...
    async process() {
        ...
        return __classPrivateFieldGet(this, _Orchestrator_instances, "m", _Orchestrator_processAtIndex).call(this, 0);
    }
}
exports.Orchestrator = Orchestrator;
_Orchestrator_lockingModule = new WeakMap(), _Orchestrator_lockingOwner = new WeakMap(), _Orchestrator_state = new WeakMap(), _Orchestrator_options = new WeakMap(), _Orchestrator_currentIndex = new WeakMap(), _Orchestrator_entities = new WeakMap(), _Orchestrator_instances = new WeakSet(), _Orchestrator_acquireLock = 
/**
...
}, _Orchestrator_processAtIndex = 
/**
 * Processes the entity at a given index. If there are no entities
 * left, the orchestrator state will be set to completed.
 */
async function _Orchestrator_processAtIndex(index) {
    const entity = __classPrivateFieldGet(this, _Orchestrator_entities, "f")[index];
    if (!entity) {
        __classPrivateFieldSet(this, _Orchestrator_state, "completed", "f");
        return;
    }
    __classPrivateFieldSet(this, _Orchestrator_currentIndex, index, "f");
    const lockAcquired = await __classPrivateFieldGet(this, _Orchestrator_instances, "m", _Orchestrator_acquireLock).call(this, entity.entity);
    if (lockAcquired) {
        try {
            await __classPrivateFieldGet(this, _Orchestrator_options, "f").taskRunner(entity);
        }
        catch (error) {
            ...
            await __classPrivateFieldGet(this, _Orchestrator_lockingModule, "f").release(entity.entity, {
                ownerId: __classPrivateFieldGet(this, _Orchestrator_lockingOwner, "f"),
            });
        }
    }
    return __classPrivateFieldGet(this, _Orchestrator_instances, "m", _Orchestrator_processAtIndex).call(this, index + 1);
};
