...
exports.adminProductRoutesMiddlewares = [
    ...
    },
    {
        ...
        middlewares: [
            (0, http_1.unlessPath)(/.*\/products\/(batch|export|import)/, (0, framework_1.validateAndTransformQuery)(validators_2.AdminGetProductParams, QueryConfig.retrieveProductQueryConfig)),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/products/:id",
        middlewares: [
            (0, http_1.unlessPath)(/.*\/products\/(batch|export|import)/, (0, framework_1.validateAndTransformBody)(validators_2.AdminUpdateProduct)),
            (0, http_1.unlessPath)(/.*\/products\/(batch|export|import)/, (0, framework_1.validateAndTransformQuery)(validators_2.AdminGetProductParams, QueryConfig.retrieveProductQueryConfig)),
        ],
    },
    {
    ...
    // Note: New endpoint in v2
    {
        ...
        middlewares: [
            (0, http_1.unlessPath)(/.*\/variants\/batch/, (0, framework_1.validateAndTransformQuery)(validators_2.AdminGetProductVariantParams, QueryConfig.retrieveVariantConfig)),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/products/:id/variants/:variant_id",
        middlewares: [
            (0, http_1.unlessPath)(/.*\/variants\/batch/, (0, framework_1.validateAndTransformBody)(validators_2.AdminUpdateProductVariant)),
            (0, http_1.unlessPath)(/.*\/variants\/batch/, (0, framework_1.validateAndTransformQuery)(validators_2.AdminGetProductParams, QueryConfig.retrieveProductQueryConfig)),
        ],
    },
    {
        method: ["DELETE"],
