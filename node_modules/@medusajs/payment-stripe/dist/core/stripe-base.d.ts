...
declare abstract class StripeBase extends AbstractPaymentProvider<StripeOptions> {
    ...
    refundPayment({ amount, data, }: RefundPaymentInput): Promise<RefundPaymentOutput>;
    retrievePayment({ data, }: RetrievePaymentInput): Promise<RetrievePaymentOutput>;
    updatePayment({ data, currency_code, amount, }: UpdatePaymentInput): Promise<UpdatePaymentOutput>;
