...
const ChoiceBox = React.forwardRef(({ className, id, label, description, ...props }, ref) => {
    ...
    return (React.createElement(Primitives.Item, { ref: ref, className: clx("shadow-borders-base bg-ui-bg-base focus-visible:shadow-borders-interactive-with-focus transition-fg group flex items-start gap-x-2 rounded-lg p-3 outline-none", "hover:enabled:bg-ui-bg-base-hover", "data-[state=checked]:shadow-borders-interactive-with-shadow", "group-disabled:cursor-not-allowed group-disabled:opacity-50", className), ...props, id: id, "aria-describedby": descriptionId },
