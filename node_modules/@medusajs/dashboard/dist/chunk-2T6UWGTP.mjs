...
var DataGridKeyboardShortcutModal = ({
  ...
  return /* @__PURE__ */ jsxs6(Root, { open, onOpenChange, children: [
    /* @__PURE__ */ jsx8(Trigger, { asChild: true, children: /* @__PURE__ */ jsx8(Button, { size: "small", variant: "secondary", children: t("dataGrid.shortcuts.label") }) }),
    /* @__PURE__ */ jsxs6(Portal, { children: [
      /* @__PURE__ */ jsx8(
        Overlay,
        {
          className: clx4(
      ...
      /* @__PURE__ */ jsxs6(Content, { className: "bg-ui-bg-subtle shadow-elevation-modal fixed left-[50%] top-[50%] flex h-full max-h-[612px] w-full max-w-[560px] translate-x-[-50%] translate-y-[-50%] flex-col divide-y overflow-hidden rounded-lg outline-none", children: [
        /* @__PURE__ */ jsxs6("div", { className: "flex flex-col gap-y-3 px-6 py-4", children: [
          /* @__PURE__ */ jsxs6("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs6("div", { children: [
              /* @__PURE__ */ jsx8(Title, { asChild: true, children: /* @__PURE__ */ jsx8(Heading, { children: t("app.menus.user.shortcuts") }) }),
              /* @__PURE__ */ jsx8(Description, { className: "sr-only" })
            ] }),
            /* @__PURE__ */ jsxs6("div", { className: "flex items-center gap-x-2", children: [
              /* @__PURE__ */ jsx8(Kbd, { children: "esc" }),
              /* @__PURE__ */ jsx8(Close, { asChild: true, children: /* @__PURE__ */ jsx8(IconButton, { variant: "transparent", size: "small", children: /* @__PURE__ */ jsx8(XMark, {}) }) })
            ] })
          ] }),
