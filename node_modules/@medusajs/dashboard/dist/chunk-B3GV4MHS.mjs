...
var FormExtensionFieldComponent = ({
  ...
  switch (type) {
    ...
    default: {
      return /* @__PURE__ */ jsx3(InlineTip, { variant: "warning", children: "The field type does not support rendering a fallback component. Please provide a component prop." });
    }
  }
};
