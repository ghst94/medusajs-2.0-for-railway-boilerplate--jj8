...
import {
  ...
  useClaims
} from "./chunk-RNTCWB6V.mjs";
import {
  useCancelExchange,
  useCancelExchangeRequest,
  useExchanges
} from "./chunk-AATVUMKV.mjs";
import {
...
import {
  ...
  useReturns
} from "./chunk-22P25LIZ.mjs";
import {
  useCancelOrderEdit,
  useConfirmOrderEdit
} from "./chunk-YN5DPKZR.mjs";
import {
  DEFAULT_FIELDS
...
import {
  useReservationItems
} from "./chunk-YYKOEGMO.mjs";
import "./chunk-PDGN4QUC.mjs";
import "./chunk-XW2FQS26.mjs";
...
var OrderActivityCollapsible = ({
  ...
  return /* @__PURE__ */ jsxs8(Collapsible.Root, { open, onOpenChange: setOpen, children: [
    !open && /* @__PURE__ */ jsxs8("div", { className: "grid grid-cols-[20px_1fr] items-start gap-2", children: [
      ...
      /* @__PURE__ */ jsx7("div", { className: "pb-4", children: /* @__PURE__ */ jsx7(Collapsible.Trigger, { className: "text-left", children: /* @__PURE__ */ jsx7(
        Text6,
        {
          size: "small",
          leading: "compact",
    ...
    /* @__PURE__ */ jsx7(Collapsible.Content, { children: /* @__PURE__ */ jsx7("div", { className: "flex flex-col gap-y-0.5", children: activities.map((item, index) => {
      return /* @__PURE__ */ jsx7(
        OrderActivityItem,
        {
          title: item.title,
...
var Fulfillment = ({
  ...
  const handleMarkAsDelivered = async () => {
    ...
    if (res) {
      await markAsDelivered(void 0, {
        onSuccess: () => {
          toast5.success(t("orders.fulfillment.toast.fulfillmentDelivered"));
        },
        onError: (e) => {
  ...
  return /* @__PURE__ */ jsxs12(Container7, { className: "divide-y p-0", children: [
    ...
    (showShippingButton || showDeliveryButton) && /* @__PURE__ */ jsxs12("div", { className: "bg-ui-bg-subtle flex items-center justify-end gap-x-2 rounded-b-xl px-4 py-4", children: [
      showDeliveryButton && /* @__PURE__ */ jsx11(Button6, { onClick: handleMarkAsDelivered, variant: "secondary", children: t("orders.fulfillment.markAsDelivered") }),
...
// ../../core/utils/src/common/is-defined.ts
function isDefined(val) {
  return typeof val !== "undefined";
}

// ../../core/utils/src/common/is-object.ts
function isObject(obj) {
  return obj != null && obj?.constructor?.name === "Object";
}

// ../../core/utils/src/common/is-string.ts
function isString(val) {
  return val != null && typeof val === "string";
}

// ../../core/utils/src/common/is-present.ts
...
var OrderSummarySection = ({ order }) => {
  ...
  return /* @__PURE__ */ jsxs17(Container9, { className: "divide-y divide-dashed p-0", children: [
    ...
    (showAllocateButton || showReturns || showPayment || showRefund) && /* @__PURE__ */ jsxs17("div", { className: "bg-ui-bg-subtle flex items-center justify-end gap-x-2 rounded-b-xl px-4 py-4", children: [
      showReturns && (receivableReturns.length === 1 ? /* @__PURE__ */ jsx16(
        Button8,
        {
          onClick: () => navigate(
      ...
      showAllocateButton && /* @__PURE__ */ jsx16(
        Button8,
        {
