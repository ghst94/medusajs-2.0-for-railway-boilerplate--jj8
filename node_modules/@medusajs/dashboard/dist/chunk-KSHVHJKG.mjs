...
import { Badge, IconButton, StatusBadge as StatusBadge2, Text as Text2, Tooltip } from "@medusajs/ui";
...
var TaxOverrideCard = ({ taxRate }) => {
  ...
  return /* @__PURE__ */ jsxs2(Collapsible.Root, { children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between px-6 py-3", children: [
      /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-x-2", children: [
        /* @__PURE__ */ jsx2(Collapsible.Trigger, { asChild: true, children: /* @__PURE__ */ jsx2(IconButton, { size: "2xsmall", variant: "transparent", className: "group", children: /* @__PURE__ */ jsx2(TriangleRightMini, { className: "text-ui-fg-muted transition-transform group-data-[state='open']:rotate-90" }) }) }),
    ...
    /* @__PURE__ */ jsx2(Collapsible.Content, { children: /* @__PURE__ */ jsxs2("div", { className: "bg-ui-bg-subtle", children: [
