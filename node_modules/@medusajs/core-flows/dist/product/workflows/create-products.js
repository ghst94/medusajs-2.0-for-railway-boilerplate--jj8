...
exports.validateProductInputStep = (0, workflows_sdk_1.createStep)(validateProductInputStepId, async (data) => {
    ...
    if (missingShippingProfileProductTitles.length) {
        throw new utils_1.MedusaError(utils_1.MedusaError.Types.INVALID_DATA, `Shipping profile is not provided for: [${missingShippingProfileProductTitles.join(", ")}].`);
    }
});
...
exports.createProductsWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createProductsWorkflowId, (input) => {
    ...
    const { products: productWithoutExternalRelations, shippingPorfileIds } = (0, workflows_sdk_1.transform)({ input }, (data) => {
        const shippingPorfileIds = [];
    ...
    const { data: shippingProfiles } = (0, common_1.useQueryGraphStep)({
    ...
    (0, exports.validateProductInputStep)({ products: input.products, shippingProfiles });
