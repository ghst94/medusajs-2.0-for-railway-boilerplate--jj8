 ...
 */
export declare const createApiKeysWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<CreateApiKeysWorkflowInput, CreateApiKeysWorkflowOutput, []>;
