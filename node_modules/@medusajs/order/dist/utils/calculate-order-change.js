    ...
    processActions() {
        ...
        for (const action of this.actions) {
            ...
            if (action.action === utils_1.ChangeActionType.CREDIT_LINE_ADD) {
                creditLineTotal = utils_1.MathBN.add(creditLineTotal, amount);
            }
            else {
        ...
        summary.accounting_total = utils_1.MathBN.sub(summary.current_order_total, creditLineTotal);
        summary.transaction_total = utils_1.MathBN.sum(...this.transactions.map((tr) => tr.amount));
        summary.current_order_total = utils_1.MathBN.sub(summary.current_order_total, creditLineTotal);
